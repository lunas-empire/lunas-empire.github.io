...
export const UI = {
  ...
  guidesIntro:['Alle Bild-Guides an einem Ort. Antippen öffnet die Originalgrafik.','All visual guides in one place. Tap any image to open the original.','Усі візуальні гайди в одному місці. Натисніть на зображення, щоб відкрити оригінал.','画像ガイドをひとまとめにしました。画像をタップすると原寸で開きます。','Tous les guides visuels au même endroit. Appuie sur une image pour ouvrir l’original.','Tutte le guide visive in un solo posto. Tocca un’immagine per aprire l’originale.','Semua panduan visual ada di satu tempat. Ketuk gambar untuk membuka versi asli.'],
